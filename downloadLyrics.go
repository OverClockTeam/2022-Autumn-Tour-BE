...
func downloadlyrics(music List) []Lyric {
	music.mrid = music.mrid[6:]
	lyricsUrl := "http://m.kuwo.cn/newh5/singles/songinfoandlrc?musicId=" + music.mrid + "&httpsStatus=1&reqId=5d3b3540-3a41-11ed-8e54-774f6359d4c7"
	...
	file, err := os.OpenFile("C:/Users/fuyik/Music/lyrics/"+music.name+".txt", os.O_WRONLY|os.O_CREATE, 0666)
	if err != nil {
		return nil
	}
	defer file.Close()
